  ...
  _updateReport() {
    ...
    switch (this.currentFactSheetType) {
      ...
      case 'Application':
        ...
        if (boundedContexts) {
          var boundedContextsNoLifecycle = this.currentExtraData.filter(fs => FilterTools.noLifecycle(fs));
          ...
          var boundedContextsNoTechnicalFit = this.currentExtraData.filter(fs => FilterTools.noTechnicalFit(fs));
